...
for (region in 1:6) {
    ...
    probands_region = probands_unrelated[regions_unrelated == region]
...
As a sanity check, let's see what the new highest kinship is, after relatedness pruning. After pruning, kinship should be less than $2^{-6} = 0.0156$.
